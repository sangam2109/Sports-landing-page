...
export const FAQS = {
  faqs_for_students: [
    ...
    },
    {
      ...
      content:
        "You can collect your QR codes and chest numbers starting from 17th February, near the sports department. The distribution timings are scheduled after 12:00 PM. Be sure to check for updates and grab your essentials for the event during this time.",
    },
    {
