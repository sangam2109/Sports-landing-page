...
export default function App() {
  return (
    <div id="EventSection" className="flex w-full flex-col justify-center">
      <Tabs
        className="m-auto w-full bg-[#0e0e0e99] text-white"
        aria-label="Options"
        color="primary"
        variant="underlined"
      >
            ...
            <CardBody className="">
              ...
              <ul className="px-4 py-2 mb-6">
                <li className="text-black ">
                  ...
                  <br />
                  1. Use Only College Email id.
                  <br />
                  2. If you don't have college email id then go to{" "}
                  <a className="text-primary" href="">
                    Help Section
                  </a>{" "}
                  and Fill the Form.
                  <br />
                  4. Follow the simple steps to sign up for the events you want
                  to participate in. <br />
                  3. You can select 3 events atmost. It can be either 2 field
                  events and 1 track events or 1 field event and 2 track events.
                  <br />
                  4. Please choose carefully, as we will not be able to
                  accommodate any changes requested by you in the.future.
                  <br />
                  5. Keep watching Announcements for live updates of Athletic
                  Meet.
                  <br />
                </li>
              </ul>
              <iframe
                src="https://www.youtube-nocookie.com/embed/-mgGnx1p3b8?modestbranding=1&rel=0&iv_load_policy=3&color=white&disablekb=1"
                ...
                <div className="border-r-2 w-1/2">
                  <ul>
                    {MaleEvents.events.map((item: string) => {
                      return <li className="text-center text-base">{item}</li>;
                    })}
                  </ul>
                </div>
